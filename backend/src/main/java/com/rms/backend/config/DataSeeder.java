...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ensurePermissionColumnCanStoreNewValues();
    ...
    private void ensurePermissionColumnCanStoreNewValues() {
        try {
            jdbcTemplate.execute("ALTER TABLE user_permissions MODIFY permission varchar(50) NOT NULL");
        } catch (Exception e) {
            log.debug("Permission column migration skipped: {}", e.getMessage());
        }
    }
}
